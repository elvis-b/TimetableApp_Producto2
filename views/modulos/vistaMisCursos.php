...
//                $curs = ControladorCursos::getCourseInfo($value['id_class']);
                echo "<tr>";
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control input-lg validarCurso nombreEditar" name="name"
                                   placeholder="Ingresar Nombre Curso">
                    ...
                    <div class="form-group">
                        <div class="input-group mb-2">
                            ...
                            <textarea id="descripcion" name="descripcion"
                                      ...
                                      placeholder="Ingrese Descripción del curso" name="descripcion"
                                      rows="3"></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="datetime-local" class="form-control input-lg inicioEditar" name="inicio"
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="datetime-local" class="form-control input-lg finalEditar" name="final"
                                   placeholder="Ingresar título producto">
