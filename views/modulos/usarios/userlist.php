...
<div class="container">
    ...
    <div class="container">
        ...
        <h1 align="center"><u>Students</u></h1>

        <form action="addoredituser">
            <button type="submit" class="btn btn-primary">Alta Student</button>
            <br><br>
        </form>
        ...
        <div class="row form-group product-chooser">
            ...
            $usarios = ControladorUsuarios::getAllStudents();
            ...
            foreach ($usarios as $key => $value) {
                ...
                echo '<td id="divCursos" style="display: flex">
                                   ...
                                   onclick="retrieveUser(' . $value["id"] . ',\'student\')"
                                   data-toggle="modal" 
                                   data-target="#modalEditarCurso">
                                   <i class="fa fa-file la-3x"></i>
                                   </button>
                                   <form id="student' . $value["id"] . '" method="POST"> 
                                        <button 
                                        class="btn btn-danger btnEliminarCurso" 
                                        onclick="askIfSure(\'student\',' . $value["id"] . ',\'studentId\')" 
                                        type="button">
                ...
                <div class="modal-body">
                    ...
                    <div class="box-body">
                        ...
                        <form method="POST">
                            ...
                            <input type="hidden" class="idCurso" id="idStudentModal" name="idStudentModal">
                            <?php
                            ControladorPlantilla::postAndReturn(
                                'ControladorUsuarios',
                                'saveStudentChanges',
